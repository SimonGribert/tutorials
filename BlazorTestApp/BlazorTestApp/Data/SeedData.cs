...
public class SeedData
{
    public static void Initialize(IServiceProvider serviceProvider)
    {
        ...
        context.Movie.AddRange(
            ...
            {
                Title = "Mad Max",
                ReleasedDate = new DateOnly(1979, 4, 12),
            ...
            new Movie
            {
                ...
                ReleasedDate = new DateOnly(1981, 12, 24),
                Genre = "Sci-fi (Cyberpunk)",
                Price = 2.78M,
                Rating = "R",
            },
            new Movie
            {
                ...
                ReleasedDate = new DateOnly(1985, 7, 10),
                Genre = "Sci-fi (Cyberpunk)",
                Price = 3.55M,
                Rating = "PG-13",
            },
            new Movie
            {
                ...
                ReleasedDate = new DateOnly(2015, 5, 15),
                Genre = "Sci-fi (Cyberpunk)",
                Price = 8.43M,
                Rating = "R",
            },
            new Movie
            {
                ...
                ReleasedDate = new DateOnly(2024, 5, 24),
                Genre = "Sci-fi (Cyberpunk)",
                Price = 13.49M,
                Rating = "R",
            });
